...
export function LoginView() {
  ...
  return (
    <div className="flex min-h-screen w-full font-serif bg-[#FDFBF7] text-[#4A0E17] selection:bg-[#D4AF37] selection:text-[#4A0E17]">
      {/* Left Branding Panel */}
      <div className="hidden lg:flex w-[45%] bg-gradient-to-br from-[#5D0F1D] via-[#4A0E17] to-[#2D060C] border-r border-[#D4AF37]/50 relative overflow-hidden flex-col justify-between p-6 z-10 shadow-[inset_-20px_0_50px_rgba(0,0,0,0.4)]">
        ...
        <div className="relative z-10 max-w-lg animate-in fade-in slide-in-from-left-8 duration-700 delay-200 pb-0">
          <div className="relative z-10 flex items-center space-x-4 animate-in fade-in slide-in-from-top-4 duration-700 pb-6">
            ...
            <div>
              <h2 className="text-2xl font-black tracking-widest uppercase leading-tight text-[#D4AF37] drop-shadow-md">
                PECC
              </h2>
          ...
          <div className="inline-block px-5 py-2 mb-6 rounded-full bg-[#3A0A11]/80 border border-[#D4AF37]/60 shadow-[0_0_15px_rgba(212,175,55,0.2)] backdrop-blur-md">
            <span className="text-[#D4AF37] pt-0 font-sans font-bold text-sm tracking-widest uppercase flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-[#D4AF37] animate-pulse" />
              Leader Election 2026
            </span>
          </div>
          <h1 className="text-5xl lg:text-5xl xl:text-5xl font-playfair font-black leading-[1.2] mb-10 tracking-tight text-[#FDFBF7] drop-shadow-[0_4px_10px_rgba(0,0,0,0.5)]">
            The Throne Awaits:
            <br />
          ...
          <p className="text-[#FDFBF7]/80 font-sans text-lg leading-relaxed font-light mt-4 drop-shadow-sm">
            Welcome to the official election system for the Polytechnic English
            Conversation Club 2026/2027. Log in to securely cast your vote and
            make an impact.
          </p>
        </div>
        ...
        <div className="relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
          <div className="flex items-center space-x-4">
            <div className="flex space-x-2">
              <div
                className="w-2.5 h-2.5 rounded-full bg-[#D4AF37] shadow-[0_0_10px_#D4AF37] animate-bounce"
                style={{ animationDelay: "0ms" }}
              ></div>
              <div
                className="w-2.5 h-2.5 rounded-full bg-[#FDFBF7] shadow-[0_0_10px_#FDFBF7] animate-bounce"
                style={{ animationDelay: "150ms" }}
              ></div>
              <div
                className="w-2.5 h-2.5 rounded-full bg-[#6B4F43] animate-bounce"
                style={{ animationDelay: "300ms" }}
              ></div>
            </div>
            <span className="text-sm font-sans font-bold text-[#D4AF37] uppercase tracking-widest drop-shadow-sm">
              Make Your Choice Matter
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative overflow-hidden bg-[#FDFBF7]">
        ...
        <div
          ...
          style={{
            backgroundImage: "radial-gradient(#6B4F43 1px, transparent 1px)",
        ...
        <div className="w-full max-w-lg lg:max-w-xl relative z-10 animate-in fade-in zoom-in-95 duration-500 delay-100">
          ...
          <div className="lg:hidden mb-10 text-center flex flex-col items-center">
            ...
            <h2 className="text-4xl font-playfair font-black text-[#4A0E17] tracking-tight drop-shadow-sm">
              PECC
            </h2>
            <p className="text-[#6B4F43] font-sans font-bold mt-2 flex items-center justify-center gap-1 uppercase tracking-widest text-sm">
              <Sparkles className="w-4 h-4 text-[#D4AF37]" /> Leader Election
              2026
            </p>
          </div>
          ...
          <div className="rounded-3xl bg-gradient-to-b from-[#D4AF37] via-[#F7B757] to-[#8B6508] p-[3px] shadow-[0_30px_60px_-15px_rgba(74,14,23,0.3)] overflow-hidden">
            <Card className="border-0 shadow-none rounded-[1.35rem] overflow-hidden bg-[#FFFDF9] backdrop-blur-xl relative">
              ...
              <CardHeader className="space-y-3 pt-8 px-8 lg:px-12 pb-6 border-b border-[#D4AF37]/20 relative z-10">
              ...
              <CardContent className="px-8 lg:px-12 pt-2 pb-6 relative z-10">
                <form onSubmit={handleLogin} className="space-y-7 font-sans">
                  <div className="space-y-2.5">
                    <Label
                      htmlFor="nim"
                      className="text-[#4A0E17] font-bold text-sm tracking-widest uppercase ml-1"
                    >
                      NIM
                    </Label>
                  ...
                  <div className="space-y-2.5">
                    <div className="flex items-center justify-between ml-1">
                      <Label
                        htmlFor="password"
                        className="text-[#4A0E17] font-bold text-sm tracking-widest uppercase"
                      >
                        Password
                      </Label>
                    </div>
                  ...
                  >
                    <span className="relative z-10 flex items-center gap-2 drop-shadow-md">
                      {loading ? (
                        ...
                        <>
                          Log In{" "}
                          <Lock className="w-4 h-4 opacity-80 group-hover:opacity-100 transition-transform group-hover:scale-110" />
                        </>
                      )}
                    </span>
